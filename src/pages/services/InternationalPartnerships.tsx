...
import { Globe, Handshake, Network, Building2, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
const features = [
  ...
  { icon: Building2, key: 'investment' },
  { icon: Globe, key: 'global' },
];

const benefits = [
  'service.intl.benefit.1',
  'service.intl.benefit.2',
  'service.intl.benefit.3',
  'service.intl.benefit.4',
  'service.intl.benefit.5',
];
...
export default function InternationalPartnerships() {
  ...
  const seoData = {
    en: {
      title: 'International Partnerships - GPD Consulting | Global Collaboration Africa',
      description: 'Build strategic international partnerships and collaborations to drive sustainable development and economic growth across African markets.',
      keywords: 'international partnerships Africa, global collaboration, strategic partnerships, foreign investment Africa, GPD Consulting',
    },
    fr: {
      title: 'Partenariats Internationaux - GPD Consulting | Collaboration Mondiale Afrique',
      description: 'Construisez des partenariats internationaux strategiques et des collaborations pour stimuler le developpement durable et la croissance economique sur les marches africains.',
      keywords: 'partenariats internationaux Afrique, collaboration mondiale, partenariats strategiques, investissement etranger Afrique, GPD Consulting',
    },
  };
  ...
  const breadcrumbs = [
    ...
    { name: language === 'fr' ? 'Partenariats Internationaux' : 'International Partnerships', url: 'https://gdpconsults.ca/services/international-partnerships' },
  ];

  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: language === 'fr' ? 'Partenariats Internationaux' : 'International Partnerships',
    description: currentSeo.description,
    url: 'https://gdpconsults.ca/services/international-partnerships',
    provider: {
      '@type': 'Organization',
      name: 'GPD Consulting',
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://gdpconsults.ca/services/international-partnerships"
        ...
        <section className="relative py-32 lg:py-40 px-4 md:px-8 bg-gray-950 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight mb-6">
              {language === 'fr' ? 'Partenariats ' : 'International '}
              <span className="gradient-text">{language === 'fr' ? 'Internationaux' : 'Partnerships'}</span>
            </h1>
            <p className="text-gray-400 text-xl max-w-2xl">
              {language === 'fr' 
                ? 'Construire des collaborations strategiques pour un impact durable.'
                : 'Building strategic collaborations for lasting impact.'}
            </p>
          </div>
        </section>
        ...
        <section className="animate-section py-24 lg:py-32 px-4 md:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
              {language === 'fr' ? 'Collaboration ' : 'Global '}
              <span className="gradient-text">{language === 'fr' ? 'Mondiale' : 'Collaboration'}</span>
            </h2>
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-item">
              {language === 'fr'
                ? 'Nous facilitons des partenariats internationaux qui connectent les investisseurs etrangers, les institutions de developpement et les acteurs locaux pour creer des synergies puissantes et des resultats durables en Afrique.'
                : 'We facilitate international partnerships that connect foreign investors, development institutions, and local actors to create powerful synergies and lasting outcomes in Africa.'}
            </p>
          </div>
        </section>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-gray-900 mb-3">
                    {t(`service.intl.${feature.key}.title`)}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {t(`service.intl.${feature.key}.desc`)}
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="animate-section py-24 px-4 md:px-8 bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            ...
            <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-item">
              {language === 'fr'
                ? 'Contactez-nous pour discuter de vos projets de partenariat.'
                : 'Contact us to discuss your partnership projects.'}
            </p>
            <Link 
