...
import { Pickaxe, HardHat, Truck, Factory, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
const features = [
  { icon: Pickaxe, key: 'exploration' },
  { icon: HardHat, key: 'operations' },
  { icon: Truck, key: 'logistics' },
  { icon: Factory, key: 'processing' },
];

const benefits = [
  'service.mining.benefit.1',
  'service.mining.benefit.2',
  'service.mining.benefit.3',
  'service.mining.benefit.4',
  'service.mining.benefit.5',
];
...
export default function MiningOperations() {
  ...
  const seoData = {
    en: {
      title: 'Mining Operations - GPD Consulting | Sustainable Mining Solutions Africa',
      description: 'Comprehensive mining operations services including exploration, extraction, logistics, and processing. We deliver sustainable mining solutions across Africa with environmental responsibility.',
      keywords: 'mining operations Africa, mining consulting, sustainable mining, mineral extraction, mining logistics, Africa mining',
    },
    fr: {
      title: 'Opérations Minières - GPD Consulting | Solutions Minières Durables en Afrique',
      description: 'Services complets d\'opérations minières incluant l\'exploration, l\'extraction, la logistique et le traitement. Nous fournissons des solutions minières durables en Afrique avec responsabilité environnementale.',
      keywords: 'opérations minières Afrique, conseil minier, exploitation minière durable, extraction minéraux, logistique minière, Afrique mines',
    },
  };
  ...
  const breadcrumbs = [
    ...
    { name: language === 'fr' ? 'Opérations Minières' : 'Mining Operations', url: 'https://gdpconsults.ca/services/mining-operations' },
  ];

  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: language === 'fr' ? 'Opérations Minières' : 'Mining Operations',
    description: currentSeo.description,
    url: 'https://gdpconsults.ca/services/mining-operations',
    provider: {
      '@type': 'Organization',
      name: 'GPD Consulting',
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://gdpconsults.ca/services/mining-operations"
        ...
        <section className="relative py-32 lg:py-40 px-4 md:px-8 bg-gray-950 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight mb-6">
              {language === 'fr' ? 'Opérations ' : 'Mining '}
              <span className="gradient-text">{language === 'fr' ? 'Minières' : 'Operations'}</span>
            </h1>
            <p className="text-gray-400 text-xl max-w-2xl">
              {language === 'fr' 
                ? 'Des solutions minières durables qui équilibrent l\'extraction de ressources avec la responsabilité environnementale.'
                : 'Sustainable mining solutions that balance resource extraction with environmental responsibility.'}
            </p>
          </div>
        </section>
        ...
        <section className="animate-section py-24 lg:py-32 px-4 md:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
              {language === 'fr' ? 'Solutions ' : 'Sustainable '}
              <span className="gradient-text">{language === 'fr' ? 'Durables' : 'Solutions'}</span>
            </h2>
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-item">
              {language === 'fr'
                ? 'Nous fournissons des services complets d\'opérations minières, de l\'exploration initiale à la livraison finale. Notre approche intègre les meilleures pratiques internationales avec une compréhension profonde du contexte africain, garantissant des opérations responsables et rentables.'
                : 'We provide comprehensive mining operations services, from initial exploration to final delivery. Our approach integrates international best practices with a deep understanding of the African context, ensuring responsible and profitable operations.'}
            </p>
          </div>
        </section>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-gray-900 mb-3">
                    {t(`service.mining.${feature.key}.title`)}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {t(`service.mining.${feature.key}.desc`)}
                  </p>
                </div>
              ))}
            </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
                  {language === 'fr' ? 'Pourquoi Nous ' : 'Why '}
                  <span className="gradient-text">{language === 'fr' ? 'Choisir' : 'Choose Us'}</span>
                </h2>
        ...
        <section className="animate-section py-24 px-4 md:px-8 bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-white mb-6 animate-item">
              ...
              <span className="gradient-text">{language === 'fr' ? 'Développer Votre Mine ?' : 'Develop Your Mine?'}</span>
            </h2>
            <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-item">
              {language === 'fr'
                ? 'Contactez-nous pour discuter de vos projets miniers et découvrir comment nous pouvons vous aider.'
                : 'Contact us to discuss your mining projects and discover how we can help.'}
            </p>
            <Link 
