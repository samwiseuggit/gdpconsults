...
import { FolderKanban, ClipboardList, Users, TrendingUp, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
const features = [
  ...
  { icon: TrendingUp, key: 'feasibility' },
  { icon: FolderKanban, key: 'management' },
];

const benefits = [
  'service.dev.benefit.1',
  'service.dev.benefit.2',
  'service.dev.benefit.3',
  'service.dev.benefit.4',
  'service.dev.benefit.5',
];
...
export default function ProjectDevelopment() {
  ...
  const seoData = {
    en: {
      title: 'Project Development - GPD Consulting | End-to-End Project Solutions Africa',
      description: 'Comprehensive project development services from concept to completion. We manage every phase of your project lifecycle for successful delivery across Africa.',
      keywords: 'project development Africa, project management, feasibility studies, project planning, Africa infrastructure projects, GPD Consulting',
    },
    fr: {
      title: 'Developpement de Projets - GPD Consulting | Solutions de Projets Afrique',
      description: 'Services complets de developpement de projets du concept a l\'achevement. Nous gerons chaque phase du cycle de vie de votre projet pour une livraison reussie en Afrique.',
      keywords: 'developpement projets Afrique, gestion de projet, etudes de faisabilite, planification projet, projets infrastructure Afrique, GPD Consulting',
    },
  };
  ...
  const breadcrumbs = [
    ...
    { name: language === 'fr' ? 'Developpement de Projets' : 'Project Development', url: 'https://gdpconsults.ca/services/project-development' },
  ];

  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: language === 'fr' ? 'Developpement de Projets' : 'Project Development',
    description: currentSeo.description,
    url: 'https://gdpconsults.ca/services/project-development',
    provider: {
      '@type': 'Organization',
      name: 'GPD Consulting',
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://gdpconsults.ca/services/project-development"
        ...
        <section className="relative py-32 lg:py-40 px-4 md:px-8 bg-gray-950 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight mb-6">
              {language === 'fr' ? 'Developpement ' : 'Project '}
              <span className="gradient-text">{language === 'fr' ? 'de Projets' : 'Development'}</span>
            </h1>
            <p className="text-gray-400 text-xl max-w-2xl">
              {language === 'fr' 
                ? 'Du concept a l\'achevement, nous gerons chaque phase de votre projet.'
                : 'From concept to completion, we manage every phase of your project.'}
            </p>
          </div>
        </section>
        ...
        <section className="animate-section py-24 lg:py-32 px-4 md:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
              {language === 'fr' ? 'Solutions ' : 'End-to-End '}
              <span className="gradient-text">{language === 'fr' ? 'Completes' : 'Solutions'}</span>
            </h2>
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-item">
              {language === 'fr'
                ? 'Notre equipe de developpement de projets possede une expertise eprouvee dans la gestion de projets complexes, des etudes de faisabilite initiales a la livraison finale. Nous assurons le succes de chaque projet grace a une planification meticuleuse et une execution de qualite.'
                : 'Our project development team has proven expertise in managing complex projects, from initial feasibility studies to final delivery. We ensure the success of every project through meticulous planning and quality execution.'}
            </p>
          </div>
        </section>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-gray-900 mb-3">
                    {t(`service.dev.${feature.key}.title`)}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {t(`service.dev.${feature.key}.desc`)}
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="animate-section py-24 px-4 md:px-8 bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-white mb-6 animate-item">
              ...
              <span className="gradient-text">{language === 'fr' ? 'Demarrer ?' : 'Start?'}</span>
            </h2>
            <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-item">
              {language === 'fr'
                ? 'Contactez-nous pour discuter de vos projets de developpement.'
                : 'Contact us to discuss your development projects.'}
            </p>
            <Link 
