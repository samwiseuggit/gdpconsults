...
import { Landmark, FileText, Users, Globe, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
const features = [
  ...
  { icon: Users, key: 'relations' },
  { icon: Globe, key: 'international' },
  { icon: Landmark, key: 'regulatory' },
];

const benefits = [
  'service.gov.benefit.1',
  'service.gov.benefit.2',
  'service.gov.benefit.3',
  'service.gov.benefit.4',
  'service.gov.benefit.5',
];
...
export default function GovernmentalAffairs() {
  ...
  const seoData = {
    en: {
      title: 'Governmental Affairs - GPD Consulting | Public Sector Advisory Africa',
      description: 'Expert governmental affairs services helping organizations navigate public sector landscapes, policy frameworks, and regulatory environments across African markets.',
      keywords: 'governmental affairs Africa, public sector advisory, policy consulting, regulatory affairs, government relations Africa, GPD Consulting',
    },
    fr: {
      title: 'Affaires Gouvernementales - GPD Consulting | Conseil Secteur Public Afrique',
      description: 'Services experts en affaires gouvernementales aidant les organisations à naviguer dans les paysages du secteur public, les cadres politiques et les environnements réglementaires sur les marchés africains.',
      keywords: 'affaires gouvernementales Afrique, conseil secteur public, consulting politique, affaires réglementaires, relations gouvernementales Afrique, GPD Consulting',
    },
  };
  ...
  const breadcrumbs = [
    ...
    { name: language === 'fr' ? 'Affaires Gouvernementales' : 'Governmental Affairs', url: 'https://gdpconsults.ca/services/governmental-affairs' },
  ];

  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: language === 'fr' ? 'Affaires Gouvernementales' : 'Governmental Affairs',
    description: currentSeo.description,
    url: 'https://gdpconsults.ca/services/governmental-affairs',
    provider: {
      '@type': 'Organization',
      name: 'GPD Consulting',
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://gdpconsults.ca/services/governmental-affairs"
        ...
        <section className="relative py-32 lg:py-40 px-4 md:px-8 bg-gray-950 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight mb-6">
              ...
              <span className="gradient-text">{language === 'fr' ? 'Gouvernementales' : 'Affairs'}</span>
            </h1>
            <p className="text-gray-400 text-xl max-w-2xl">
              {language === 'fr' 
                ? 'Naviguer efficacement dans les paysages du secteur public et les cadres réglementaires.'
                : 'Navigating public sector landscapes and regulatory frameworks effectively.'}
            </p>
          </div>
        </section>
        ...
        <section className="animate-section py-24 lg:py-32 px-4 md:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
              {language === 'fr' ? 'Conseil ' : 'Public '}
              <span className="gradient-text">{language === 'fr' ? 'Sectoriel' : 'Sector Advisory'}</span>
            </h2>
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-item">
              {language === 'fr'
                ? 'Notre equipe d\'experts en affaires gouvernementales possede une connaissance approfondie des environnements politiques et reglementaires africains. Nous aidons les organisations a etablir des relations efficaces avec les gouvernements, a comprendre les cadres politiques et a naviguer dans les processus reglementaires complexes.'
                : 'Our governmental affairs team has deep knowledge of African policy and regulatory environments. We help organizations establish effective relationships with governments, understand policy frameworks, and navigate complex regulatory processes.'}
            </p>
          </div>
        </section>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-gray-900 mb-3">
                    {t(`service.gov.${feature.key}.title`)}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {t(`service.gov.${feature.key}.desc`)}
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="animate-section py-24 px-4 md:px-8 bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            ...
            <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-item">
              {language === 'fr'
                ? 'Contactez-nous pour discuter de vos besoins en affaires gouvernementales.'
