...
import { TrendingUp, Landmark, FileText, Users, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
const features = [
  { icon: Landmark, key: 'policy' },
  { icon: FileText, key: 'advocacy' },
  { icon: Users, key: 'stakeholder' },
  { icon: TrendingUp, key: 'impact' },
];

const benefits = [
  'service.lobby.benefit.1',
  'service.lobby.benefit.2',
  'service.lobby.benefit.3',
  'service.lobby.benefit.4',
  'service.lobby.benefit.5',
];

export default function EconomicLobbying() {
  ...
  const seoData = {
    en: {
      title: 'Economic Lobbying - GPD Consulting | Policy Advocacy Africa',
      description: 'Strategic economic lobbying and policy advocacy services to influence decision-making and create favorable business environments across Africa.',
      keywords: 'economic lobbying Africa, policy advocacy, government relations, business environment, policy influence, GPD Consulting',
    },
    fr: {
      title: 'Lobbying Economique - GPD Consulting | Plaidoyer Politique Afrique',
      description: 'Services strategiques de lobbying economique et de plaidoyer politique pour influencer la prise de decision et creer des environnements commerciaux favorables en Afrique.',
      keywords: 'lobbying economique Afrique, plaidoyer politique, relations gouvernementales, environnement commercial, influence politique, GPD Consulting',
    },
  };
  ...
  const breadcrumbs = [
    ...
    { name: language === 'fr' ? 'Lobbying Economique' : 'Economic Lobbying', url: 'https://gdpconsults.ca/services/economic-lobbying' },
  ];

  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: language === 'fr' ? 'Lobbying Economique' : 'Economic Lobbying',
    description: currentSeo.description,
    url: 'https://gdpconsults.ca/services/economic-lobbying',
    provider: {
      '@type': 'Organization',
      name: 'GPD Consulting',
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://gdpconsults.ca/services/economic-lobbying"
        ...
        <section className="relative py-32 lg:py-40 px-4 md:px-8 bg-gray-950 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight mb-6">
              {language === 'fr' ? 'Lobbying ' : 'Economic '}
              <span className="gradient-text">{language === 'fr' ? 'Economique' : 'Lobbying'}</span>
            </h1>
            <p className="text-gray-400 text-xl max-w-2xl">
              {language === 'fr' 
                ? 'Influencer les decisions pour creer des environnements commerciaux favorables.'
                : 'Influencing decisions to create favorable business environments.'}
            </p>
          </div>
        </section>
        ...
        <section className="animate-section py-24 lg:py-32 px-4 md:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
              {language === 'fr' ? 'Plaidoyer ' : 'Policy '}
              <span className="gradient-text">{language === 'fr' ? 'Politique' : 'Advocacy'}</span>
            </h2>
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-item">
              {language === 'fr'
                ? 'Notre equipe de lobbying economique possede une expertise approfondie dans l\'influence des politiques publiques et la creation d\'environnements commerciaux favorables. Nous travaillons avec les decideurs pour faciliter les investissements et le developpement economique.'
                : 'Our economic lobbying team has deep expertise in influencing public policy and creating favorable business environments. We work with decision-makers to facilitate investment and economic development.'}
            </p>
          </div>
        </section>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-gray-900 mb-3">
                    {t(`service.lobby.${feature.key}.title`)}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {t(`service.lobby.${feature.key}.desc`)}
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="animate-section py-24 px-4 md:px-8 bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-white mb-6 animate-item">
              ...
              <span className="gradient-text">{language === 'fr' ? 'Influencer ?' : 'Influence?'}</span>
            </h2>
            <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-item">
              {language === 'fr'
                ? 'Contactez-nous pour discuter de vos besoins en lobbying economique.'
                : 'Contact us to discuss your economic lobbying needs.'}
            </p>
            <Link 
