...
import { Ruler, Building2, Compass, HardHat, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
const features = [
  { icon: Building2, key: 'design' },
  { icon: Compass, key: 'planning' },
  { icon: HardHat, key: 'supervision' },
  { icon: Ruler, key: 'technical' },
];

const benefits = [
  'service.arch.benefit.1',
  'service.arch.benefit.2',
  'service.arch.benefit.3',
  'service.arch.benefit.4',
  'service.arch.benefit.5',
];
...
export default function ArchitectureEngineering() {
  ...
  const seoData = {
    en: {
      title: 'Architecture & Engineering - GPD Consulting | Design Excellence Africa',
      description: 'Comprehensive architecture and engineering services for infrastructure, buildings, and industrial projects across Africa. Design excellence meets local expertise.',
      keywords: 'architecture engineering Africa, building design, infrastructure engineering, construction supervision, technical design Africa, GPD Consulting',
    },
    fr: {
      title: 'Architecture & Ingenierie - GPD Consulting | Excellence de Conception Afrique',
      description: 'Services complets d\'architecture et d\'ingenierie pour les infrastructures, les batiments et les projets industriels en Afrique. L\'excellence de la conception rencontre l\'expertise locale.',
      keywords: 'architecture ingenierie Afrique, conception batiments, ingenierie infrastructure, supervision construction, conception technique Afrique, GPD Consulting',
    },
  };
  ...
  const breadcrumbs = [
    ...
    { name: language === 'fr' ? 'Architecture & Ingenierie' : 'Architecture & Engineering', url: 'https://gdpconsults.ca/services/architecture-engineering' },
  ];

  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: language === 'fr' ? 'Architecture & Ingenierie' : 'Architecture & Engineering',
    description: currentSeo.description,
    url: 'https://gdpconsults.ca/services/architecture-engineering',
    provider: {
      '@type': 'Organization',
      name: 'GPD Consulting',
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://gdpconsults.ca/services/architecture-engineering"
        ...
        <section className="relative py-32 lg:py-40 px-4 md:px-8 bg-gray-950 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight mb-6">
              ...
              <span className="gradient-text">{language === 'fr' ? '& Ingenierie' : '& Engineering'}</span>
            </h1>
            <p className="text-gray-400 text-xl max-w-2xl">
              {language === 'fr' 
                ? 'L\'excellence de la conception rencontre l\'expertise locale.'
                : 'Design excellence meets local expertise.'}
            </p>
          </div>
        </section>
        ...
        <section className="animate-section py-24 lg:py-32 px-4 md:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
              ...
              <span className="gradient-text">{language === 'fr' ? 'Innovante' : 'Innovation'}</span>
            </h2>
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-item">
              {language === 'fr'
                ? 'Notre equipe d\'architecture et d\'ingenierie combine l\'innovation technique avec une comprehension profonde des contextes locaux africains. Nous concevons des solutions durables qui repondent aux besoins specifiques de chaque projet.'
                : 'Our architecture and engineering team combines technical innovation with a deep understanding of African local contexts. We design sustainable solutions that meet the specific needs of each project.'}
            </p>
          </div>
        </section>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-gray-900 mb-3">
                    {t(`service.arch.${feature.key}.title`)}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {t(`service.arch.${feature.key}.desc`)}
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="animate-section py-24 px-4 md:px-8 bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            ...
            <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-item">
              {language === 'fr'
                ? 'Contactez-nous pour discuter de vos projets d\'architecture et d\'ingenierie.'
                : 'Contact us to discuss your architecture and engineering projects.'}
            </p>
            <Link 
