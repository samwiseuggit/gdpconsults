...
import { Leaf, Zap, Sun, Droplets, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
const benefits = [
  'service.green.benefit.1',
  'service.green.benefit.2',
  'service.green.benefit.3',
  'service.green.benefit.4',
  'service.green.benefit.5',
];
...
export default function GreenTechnology() {
  ...
  const seoData = {
    en: {
      title: 'Green Technology - GPD Consulting | Sustainable Solutions Africa',
      description: 'Innovative green technology solutions for renewable energy, sustainable infrastructure, and environmental stewardship across Africa.',
      keywords: 'green technology Africa, renewable energy, solar power, sustainable infrastructure, clean technology, GPD Consulting',
    },
    fr: {
      title: 'Technologie Verte - GPD Consulting | Solutions Durables Afrique',
      description: 'Solutions innovantes de technologie verte pour les energies renouvelables, les infrastructures durables et la gestion environnementale en Afrique.',
      keywords: 'technologie verte Afrique, energie renouvelable, energie solaire, infrastructure durable, technologie propre, GPD Consulting',
    },
  };
  ...
  const breadcrumbs = [
    ...
    { name: language === 'fr' ? 'Technologie Verte' : 'Green Technology', url: 'https://gdpconsults.ca/services/green-technology' },
  ];

  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: language === 'fr' ? 'Technologie Verte' : 'Green Technology',
    description: currentSeo.description,
    url: 'https://gdpconsults.ca/services/green-technology',
    provider: {
      '@type': 'Organization',
      name: 'GPD Consulting',
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://gdpconsults.ca/services/green-technology"
        ...
        <section className="relative py-32 lg:py-40 px-4 md:px-8 bg-gray-950 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight mb-6">
              {language === 'fr' ? 'Technologie ' : 'Green '}
              <span className="gradient-text">{language === 'fr' ? 'Verte' : 'Technology'}</span>
            </h1>
        ...
        <section className="animate-section py-24 lg:py-32 px-4 md:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-item">
              {language === 'fr'
                ? 'Nous developpons et implementons des technologies vertes qui reduisent l\'impact environnemental tout en ameliorant l\'efficacite. De l\'energie renouvelable aux infrastructures durables, nous creons un avenir plus vert pour l\'Afrique.'
                : 'We develop and implement green technologies that reduce environmental impact while improving efficiency. From renewable energy to sustainable infrastructure, we are creating a greener future for Africa.'}
            </p>
          </div>
        </section>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-gray-900 mb-3">
                    {t(`service.green.${feature.key}.title`)}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {t(`service.green.${feature.key}.desc`)}
                  </p>
                </div>
              ))}
            </div>
        ...
        <section className="animate-section py-24 px-4 md:px-8 bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-white mb-6 animate-item">
              ...
              <span className="gradient-text">{language === 'fr' ? 'Passer au Vert ?' : 'Go Green?'}</span>
            </h2>
            <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-item">
              {language === 'fr'
                ? 'Contactez-nous pour discuter de vos projets de technologie verte.'
                : 'Contact us to discuss your green technology projects.'}
            </p>
            <Link 
