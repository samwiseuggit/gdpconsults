...
import { Building2, Route, Zap, Droplets, CheckCircle2, ArrowUpRight } from 'lucide-react';
...
const features = [
  { icon: Building2, key: 'urban' },
  { icon: Route, key: 'transport' },
  { icon: Zap, key: 'energy' },
  { icon: Droplets, key: 'water' },
];

const benefits = [
  'service.infra.benefit.1',
  'service.infra.benefit.2',
  'service.infra.benefit.3',
  'service.infra.benefit.4',
  'service.infra.benefit.5',
];
...
export default function InfrastructureDevelopment() {
  ...
  const seoData = {
    en: {
      title: 'Infrastructure Development - GPD Consulting | Building Africa\'s Future',
      description: 'Comprehensive infrastructure development services including urban planning, transportation, energy, and water systems. We build the foundations for Africa\'s economic growth.',
      keywords: 'infrastructure development Africa, urban planning, transportation infrastructure, energy infrastructure, water systems, Africa development',
    },
    fr: {
      title: 'Développement des Infrastructures - GPD Consulting | Construire l\'Avenir de l\'Afrique',
      description: 'Services complets de développement des infrastructures incluant l\'urbanisme, les transports, l\'énergie et les systèmes d\'eau. Nous construisons les fondations de la croissance économique de l\'Afrique.',
      keywords: 'développement infrastructure Afrique, urbanisme, infrastructure transport, infrastructure énergie, systèmes eau, développement Afrique',
    },
  };
  ...
  const breadcrumbs = [
    ...
    { name: language === 'fr' ? 'Développement des Infrastructures' : 'Infrastructure Development', url: 'https://gdpconsults.ca/services/infrastructure-development' },
  ];

  const structuredData = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: language === 'fr' ? 'Développement des Infrastructures' : 'Infrastructure Development',
    description: currentSeo.description,
    url: 'https://gdpconsults.ca/services/infrastructure-development',
    provider: {
      '@type': 'Organization',
      name: 'GPD Consulting',
  ...
  return (
    <>
      <SEO
        ...
        canonicalUrl="https://gdpconsults.ca/services/infrastructure-development"
        ...
        <section className="relative py-32 lg:py-40 px-4 md:px-8 bg-gray-950 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto">
            ...
            <h1 className="font-heading text-5xl md:text-6xl lg:text-7xl font-bold text-white max-w-4xl leading-tight mb-6">
              {language === 'fr' ? 'Développement des ' : 'Infrastructure '}
              <span className="gradient-text">{language === 'fr' ? 'Infrastructures' : 'Development'}</span>
            </h1>
            <p className="text-gray-400 text-xl max-w-2xl">
              {language === 'fr' 
                ? 'Construire les fondations pour la croissance économique de l\'Afrique.'
                : 'Building the foundations for Africa\'s economic growth.'}
            </p>
          </div>
        </section>
        ...
        <section className="animate-section py-24 lg:py-32 px-4 md:px-8 bg-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
              {language === 'fr' ? 'Construire ' : 'Building '}
              <span className="gradient-text">{language === 'fr' ? 'l\'Avenir' : 'the Future'}</span>
            </h2>
            <p className="text-gray-600 text-lg md:text-xl leading-relaxed animate-item">
              {language === 'fr'
                ? 'Nous concevons et développons des infrastructures essentielles qui soutiennent le développement économique et améliorent la qualité de vie. De l\'urbanisme aux systèmes de transport, d\'énergie et d\'eau, nous créons des solutions durables qui servent les générations futures.'
                : 'We design and develop essential infrastructure that supports economic development and improves quality of life. From urban planning to transportation, energy, and water systems, we create sustainable solutions that serve future generations.'}
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900">
                {language === 'fr' ? 'Nos ' : 'Our '}
                <span className="gradient-text">{language === 'fr' ? 'Domaines' : 'Expertise'}</span>
              </h2>
            </div>
              ...
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <h3 className="font-heading text-xl font-bold text-gray-900 mb-3">
                    {t(`service.infra.${feature.key}.title`)}
                  </h3>
                  <p className="text-gray-500 text-sm leading-relaxed">
                    {t(`service.infra.${feature.key}.desc`)}
                  </p>
                </div>
              ))}
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <h2 className="font-heading text-4xl md:text-5xl font-bold text-gray-900 mb-8 animate-item">
                  ...
                  <span className="gradient-text">{language === 'fr' ? 'Nous Choisir' : 'Choose Us'}</span>
                </h2>
        ...
        <section className="animate-section py-24 px-4 md:px-8 bg-gray-950 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            <h2 className="font-heading text-4xl md:text-5xl font-bold text-white mb-6 animate-item">
              ...
              <span className="gradient-text">{language === 'fr' ? 'Construire ?' : 'Build?'}</span>
            </h2>
            <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto animate-item">
              {language === 'fr'
                ? 'Contactez-nous pour discuter de vos projets d\'infrastructure et découvrir comment nous pouvons vous aider.'
                : 'Contact us to discuss your infrastructure projects and discover how we can help.'}
            </p>
            <Link 
